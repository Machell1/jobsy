"""SQLAlchemy ORM models for the noticeboard service."""
...
class Post(Base):
    ...
    moderation_reviewed_at = Column(DateTime(timezone=True), nullable=True)
...
class PostLike(Base):
    ...
    __table_args__ = (
        UniqueConstraint("user_id", "target_type", "target_id", name="uq_post_likes_user_target"),
