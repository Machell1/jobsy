...
6. Deploy and the bot starts automatically and runs 24/7
...
- **No credit card required** to start, just sign up with GitHub
...
- **Render** (render.com) has a free background worker tier
- **Fly.io** has a free tier with 3 shared VMs
- **Oracle Cloud** has an always-free ARM instance (best for permanent hosting)
...
4. The alert contains your **affiliate link** so you earn commission on purchases
...
4. **Run during deal events** (Prime Day, Black Friday) and set interval to 15 mins
5. **Use /deals** regularly since aggregator deals get the most engagement
6. **Use /lifestyle** to find flight, gift, and event deals in high commission categories
7. **Target seasonal events** like wedding season, holidays, and baby showers for big commissions
