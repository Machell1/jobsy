          ...
          <div className="space-y-8">
            <div className="p-4 bg-green-50 border border-green-200 rounded-lg mb-2">
              <p className="text-sm text-green-800 leading-relaxed">
                These Terms are governed by the <strong>Laws of Jamaica</strong>. By using Jobsy, you
                agree to the jurisdiction of the Courts of Jamaica for any disputes arising from these
                Terms.
              </p>
            </div>
            ...
            <div>
              ...
              <ul className="list-disc list-inside text-sm text-gray-600 space-y-1.5">
                ...
                <li>Be legally capable of entering into binding contracts under Jamaican law</li>
                <li>Not be a person barred from receiving services under the laws of Jamaica</li>
                <li>Reside in or operate a business within Jamaica (for service providers)</li>
                <li>Have a valid phone number and/or email address for verification</li>
              </ul>
            </div>
            ...
            <div>
              <h2 className="text-xl font-bold text-gray-900 mb-3">5. User Roles and Responsibilities</h2>
              <p className="text-sm text-gray-600 leading-relaxed mb-3">
            ...
            <div>
              <h2 className="text-xl font-bold text-gray-900 mb-3">6. Service Bookings and Transactions</h2>
              <ul className="list-disc list-inside text-sm text-gray-600 space-y-1.5">
            ...
            <div>
              <h2 className="text-xl font-bold text-gray-900 mb-3">7. Payments and Platform Fees</h2>
              <p className="text-sm text-gray-600 leading-relaxed mb-3">
            ...
            <div>
              <h2 className="text-xl font-bold text-gray-900 mb-3">8. Reviews and Ratings</h2>
              <p className="text-sm text-gray-600 leading-relaxed">
            ...
            <div>
              <h2 className="text-xl font-bold text-gray-900 mb-3">9. Prohibited Conduct</h2>
              <p className="text-sm text-gray-600 leading-relaxed mb-3">
                You agree not to:
              </p>
              <ul className="list-disc list-inside text-sm text-gray-600 space-y-1.5">
            ...
            <div>
              ...
              <p className="text-sm text-gray-600 leading-relaxed">
                You agree to indemnify, defend, and hold harmless Jobsy, its officers, directors,
                employees, agents, and affiliates from and against any and all claims, damages,
                obligations, losses, liabilities, costs, and expenses (including reasonable attorney's
                fees) arising from: (a) your use of or access to the Service; (b) your violation of
                these Terms; (c) your violation of any third-party right, including intellectual
                property, privacy, or contractual rights; (d) any content you post or submit through
                the Service; or (e) any services you provide or receive through the platform.
              </p>
            </div>
