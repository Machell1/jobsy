"""Geoshard routes merged into the gateway (formerly geoshard microservice)."""
...
from ..models_geoshard import GeoshardEntry

# Import S2 utilities from the geoshard service package
from geoshard.app.s2_utils import get_covering_cells, haversine_km
