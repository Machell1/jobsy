"""Search routes merged into the gateway (formerly search microservice)."""
...
from ..models_search import SavedSearch

# Import the elasticsearch client from the search service package.
# It uses shared.config and shared.database so it works in any context.
from search.app.elasticsearch_client import search_listings, search_profiles
