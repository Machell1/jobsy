...
MAX_FILE_SIZE = MAX_IMAGE_FILE_SIZE  # Default for backward compatibility
...
def upload_file(
    ...
    """
    max_size = MAX_VIDEO_FILE_SIZE if content_type in ALLOWED_VIDEO_TYPES else MAX_IMAGE_FILE_SIZE
