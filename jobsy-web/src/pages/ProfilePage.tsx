...
export default function ProfilePage() {
  ...
  const [portfolioForm, setPortfolioForm] = useState({ title: '', description: '', image_url: '', link: '' })
  ...
  const closePortfolioModal = () => {
    ...
    setPortfolioForm({ title: '', description: '', image_url: '', link: '' })
  }
            ...
            <form onSubmit={handlePortfolioSubmit} className="space-y-4">
              ...
              <div>
                ...
                <input
                  ...
                  onChange={e => setPortfolioForm(f => ({ ...f, image_url: e.target.value }))}
                  placeholder="https://..."
                  className="w-full px-3 py-2.5 border border-gray-300 rounded-lg text-sm focus:outline-none focus:ring-2 focus:ring-primary/30 focus:border-primary"
                />
              </div>
